...
export declare type DisplaySetting = '' | 'verbose' | 'detailed' | 'normal' | 'minimal' | 'errors-only' | 'none';
export declare type VerbositySetting = 'none' | 'info' | 'verbose';
...
export declare type WebpackDriverArgs = WebpackArgs;
